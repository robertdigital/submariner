...
func registerFlags(t *TestContextType) {
	...
	flag.UintVar(&TestContext.ConnectionTimeout, "connection-timeout", 60, "The timeout in seconds per connection attempt when verifying communication between clusters.")
	flag.UintVar(&TestContext.ConnectionAttempts, "connection-attempts", 4, "The number of connection attempts when verifying communication between clusters.")
